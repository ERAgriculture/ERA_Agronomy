...
- Includes practical steps for data cleaning, visualization, and advanced analysis.
    ...
    1.2 ERA Agroecology is a subset of the LAC studies (https://eragriculture.github.io/ERA_Agronomy/ERA-Agroecology.html). The training syllabus for this round of extraction can be found here: https://eragriculture.github.io/ERA_Agronomy/ERA-Agroecology-Training-Syllabus.html
...
![SFP Logo](images/SFP.logo.png)
![CA Logo](images/Climate Action Logo.png)

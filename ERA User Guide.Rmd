...
`ERA.Compiled<- ERA.Compiled`

To view the field descript, run the following line:\
\
...
ERACompiledFields<- ERAg::ERACompiledFields
...
practices<- ERAg::PracticeCodes
outcomes<- ERAg::OutcomeCodes
products<- ERAg::EUCodes
...
Unhide the code to see how we sub-set the data to agronomy papers only.
...
Say something about era practices............
.............................................
...
Lets assume you want to explore the impact of agriculture technologies on Maize yields.
ERA only considers treatment comparisons. Each observation encodes a comparison between two treatments.
